...
// Parse JSON and URL-encoded request bodies for API endpoints (with 50mb limit for bulk imports)
...
const cleanRoutes = [
  ...
  { route: '/aliexpress', file: 'aliexpress-coupons.html' },
  { route: '/aliexpress-coupons', file: 'aliexpress-coupons.html' },
  { route: '/store/aliexpress', file: 'aliexpress-coupons.html' },
